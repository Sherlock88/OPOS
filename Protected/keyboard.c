...
unsigned char keyboard_buffer[255];		/* keyboard_buffer stores every key typed */
unsigned char keyboard_buffer_size = 0;	/* keyboard_buffer_size stores the number of keys in the buffer */
...
void InitKeyboard()
{
	...
	led_status = 0; /* All leds off ,FORMAT: [CAPS],[NUM],[SCROLL]*/
	setleds();
}
